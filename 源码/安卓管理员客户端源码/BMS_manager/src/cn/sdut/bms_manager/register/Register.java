							...
							try {
								...
								if (code == 200) {
									...
									runOnUiThread(new Runnable() {
										...
										public void run() {
											// TODO Auto-generated method stub
									Toast.makeText(Register.this, "服务器请求失败", Toast.LENGTH_LONG).show();	
										}
									});
		...
		btn_next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(et_phone.getText().toString().trim().equals("")){
					Toast.makeText(Register.this, "请先输入手机号并获取验证码", Toast.LENGTH_LONG).show();
				}else if(returncode==null){
					Toast.makeText(Register.this, "请先点击获取验证码", Toast.LENGTH_LONG).show();
				}
