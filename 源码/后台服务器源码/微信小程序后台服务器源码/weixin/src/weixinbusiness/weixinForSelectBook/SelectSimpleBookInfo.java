...
/**
 * Servlet implementation class CompleteSelectBook
 */
@WebServlet("/selectSimpleBookInfo")
public class SelectSimpleBookInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SelectSimpleBookInfo() {
		super();
	...
	// bookData.getCompleteBooks(request.getParameter("info"),
	// (LinkedBlockingQueue<Connection>)
	// servletContext.getAttribute("connections"));
	// for (Book bookins : books) {
	// makeBookToinfo.addsimpleteinfo(makeBookToinfo.createItemString(2,
	// this.createStringarray(bookins)));
	// }
	// bookData.closeAll();
	// System.out.println(makeBookToinfo.returnJOSN());
	/**
