...
/**
 * Servlet implementation class GetBookJIYUEZHONG
 */
@WebServlet("/GetBookJIYUEZHONG")
public class GetBookJIYUEZHONG extends HttpServlet {
	private static final long serialVersionUID = 1L; 
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetBookJIYUEZHONG() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		NDateBussiness nDateBussiness = new NDateBussiness((LinkedBlockingQueue<Connection>) request.getServletContext().getAttribute("connections")
				, number);
		rPrintWriter.println(nDateBussiness.getJOSNForJIESHUZHONG());
