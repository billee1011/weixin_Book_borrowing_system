...
/**
 * Servlet implementation class GetJOSNJIEYUELE
 */
@WebServlet("/GetJOSNJIEYUELE")
public class GetJOSNJIEYUELE extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetJOSNJIEYUELE() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		NDateBussiness nDateBussiness = new NDateBussiness((LinkedBlockingQueue<Connection>) request.getServletContext().getAttribute("connections")
				, number);
		rPrintWriter.println(nDateBussiness.getJOSNForJIESHU());
